...
@section('per_page_title')
    {{ __('Create Products | Super Admin Dashboard') }}
@endsection
                            ...
                            <div class="col-12">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('products.all') }}">{{ __('Products') }}</a></li>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">{{ __('Create Products') }}</h5>                                    
                                            <a class="text" href="{{ route('products.all') }}" class="btn btn-outline-dark waves-effect waves-light float-end">{{ __('All Products') }}</a>
                                    
                                    </div>
                                    <div class="card-body">

                                        <form class="ajax-form" action="{{ route('products.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <!-- product name start -->
