...
@section('per_page_title')
    {{ __('Super Admin Dashboard | All Posts') }}
@endsection
                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-success add-btn" id="create-btn" ><i class="ri-add-line align-bottom me-1"></i><a href="{{ route('post.create.page') }}">Add</a> </button>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <button class="btn btn-sm btn-success edit-item-btn"><a href="{{ route('post.edit',['id'=>encrypt($single_post->id)]) }}">Edit</a> </button>
                                                            </div>
                                                            <div class="remove"> 
                                                                <a class="btn btn-danger delete_user" onclick="confirm('are you sure to delete ?')" href={{ route('post.delete',['id'=>encrypt($single_post->id)]) }}>Delete</a> 
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    $.each(response.searchResult , function(index, val) { 
                        let post_edit_route = "{{ route('post.edit',':id') }}";
