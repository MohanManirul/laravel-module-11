                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">{{ __('Create Post') }}</h5>                                    
                                            <a class="text" href="{{ route('post.all') }}" class="btn btn-outline-dark waves-effect waves-light float-end">{{ __('All Post') }}</a>
                                    
                                    </div>
                                    <div class="card-body">

                                        <form class="ajax-form" action="{{ route('post.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
