...
@section('per_page_title')
    {{ __('Super Admin Dashboard | All Bus Routes') }}
@endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">All Bus Routes</h4>
                        </div><!-- end card header -->
                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-success add-btn" id="create-btn" ><i class="ri-add-line align-bottom me-1"></i><a href="{{ route('bus.route.create.page') }}"><span style="color:#fff">Add</span> </a></button>
                                        ...
                                        <tbody id="dynamic-row" class="list form-check-all">
                                            @foreach ($all_routes as $key=>$all_route)                                                
                                                <tr>
                                                    ...
                                                    <td class="email">{{ $all_route->route_name }}</td>                                                  
                                                    <td class="email">
                                                    @if ($all_route->is_active = true)
