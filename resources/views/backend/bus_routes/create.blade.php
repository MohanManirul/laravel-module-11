...
@section('per_page_title')
    {{ __('Create Bus Route | Super Admin Dashboard') }}
@endsection
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">{{ __('Create Bus Route') }}</h5>                                    
                                            <a class="text" href="{{ route('bus.route.all') }}" class="btn btn-outline-dark waves-effect waves-light float-end">{{ __('All Bus Route') }}</a>
                                    
                                    </div>
                                    <div class="card-body">

                                        <form class="ajax-form" action="{{ route('bus.route.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12 mb-2 form-group ">
                                                    ...
                                                    <input type="text" name="route_name" class="form-control" id="route_name" placeholder="{{ __('Enter Bus Route Name') }}">                                                        
                                                </div>                                                    
