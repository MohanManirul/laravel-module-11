...
@section('per_page_title')
    {{ __('Create Fare Variant | Super Admin Dashboard') }}
@endsection
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">{{ __('Create Fare Variant') }}</h5>                                    
                                            <a class="text" href="{{ route('fares.all') }}" class="btn btn-outline-dark waves-effect waves-light float-end">{{ __('All Fare Variant') }}</a>
                                        ...
                                        <form class="ajax-form" action="{{ route('fares.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12 mb-2 form-group ">
                                                    ...
                                                    <input type="time"  class="form-control" name="departure_at" id="departure_at" placeholder="{{ __('Departure Time') }}" >                                                        
                                                </div>                                                    
                                                <!-- departure time ends -->
                                                ...
                                                <div class="col-md-6 col-12 mb-2 form-group ">
                                                    ...
                                                    <input type="time"  class="form-control" name="araival_at" id="araival_at" placeholder="{{ __('Arival Time') }}" >                                                        
                                                </div>                                                    
                                                <!-- ariaval time ends -->
