            ...
            <div class="row">
                <div class="row col-lg-12 text-center">
                    <div class="card col-md-3"  style="margin: auto;">
                      ...
                      <div class="card col-md-3"   style="margin: auto;">
                        <h1>Syndicate App</h1>
                        <img src="{{ asset('images/onion-removebg-preview.png') }}" alt="">
                        {{-- <a target="__blank"  href="{{ route('home') }}"><div class="card-body">All Posts</div></a> --}}
                      </div>
                    <div class="card col-md-3"  style="margin: auto;">
                        <a target="__blank" href="{{ route('front.login') }}"><div class="card-body">ShopKeeper Login</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0">&copy;
                            <script>document.write(new Date().getFullYear())</script> {{ __('Manirul') }} <i class="mdi mdi-heart text-danger"></i>
                        </p>
                    </div>
                </div>
            </div>
